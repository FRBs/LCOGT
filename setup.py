...
#
setup_keywords['name'] = 'frblcogt'
setup_keywords['description'] = 'Python code for LCOGT work and FRBs'
setup_keywords['author'] = 'FRB Community'
setup_keywords['author_email'] = ''
setup_keywords['license'] = 'BSD'
setup_keywords['url'] = 'https://github.com/FRBs/LCOGT'
